  ...
  return (
    <div className="flex-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6 sm:gap-3">
        <GenericCard logo="https://rogeliomenco.github.io/assets_repo/weather/wind_2.svg" title="Wind Speed" text={weather.wind.speed + "m/s"} />
        <GenericCard logo="https://rogeliomenco.github.io/assets_repo/weather/humidity_2.svg" title="Humidity" text={weather.humidity + "%"} />
        <GenericCard logo="https://rogeliomenco.github.io/assets_repo/weather/cloudiness.svg" title="Cloudiness" text={weather.cloudiness + "%"} />
      </div>
    </div>
  );
};
